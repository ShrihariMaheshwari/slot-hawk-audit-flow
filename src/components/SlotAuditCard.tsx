...
const badgeColors: Record<string, string> = {
  "Wrong Inventory": "bg-red-200 text-red-800",
  "Wrong Quantity": "bg-orange-200 text-orange-800",
  "Missing Label": "bg-yellow-100 text-yellow-900",
  ...
  return (
    <div className="w-full max-w-xl mx-auto p-5 rounded-xl bg-white shadow flex flex-col gap-3 border border-gray-100 animate-fade-in">
      ...
      {!audited ? (
          ...
          <div className="flex gap-3 flex-wrap mb-2">
            {slot.discrepancy && (
              <>
                ...
                <Button
                  variant="outline"
                  className="border-green-500 text-green-800"
        ...
        <div>
          <div className={`inline-block rounded px-3 py-1 text-sm font-semibold ${badgeColors[slot.auditResult || "Validated"]}`}>
